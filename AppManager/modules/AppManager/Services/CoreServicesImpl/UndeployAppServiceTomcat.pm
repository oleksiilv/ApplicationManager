package AppManager::Services::CoreServicesImpl::UndeployAppServiceTomcat;
...
with 'AppManager::Services::CoreServicesInterfaces::UndeployAppServiceInterface';
...
sub undeploy_app {
    ...
    my $action_url = $app_server_manager_model->get_url_for_undeploy_app( application => $application );
